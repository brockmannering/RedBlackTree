...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    public void week05ActivityTestPart1() {
        ...
        RedBlackTree<Integer> rb1 = new RedBlackTree<Integer>();
        rb1.insert(3); //w
        rb1.insert(1); //x
        rb1.insert(5); //y
        rb1.insert(0); //v
        ...
        rb1.rotate(rb1.root.leftChild.rightChild, rb1.root.leftChild);
        String currentTree = rb1.root.toString();
        String correctString = "[3, 2, 5, 1, 4, 6, 0]";
        
        assertEquals(correctString, currentTree);
    ...
    public void week05ActivityTestPart2() {
        ...
        rb1.insert(2); //u
        rb1.insert(6); //z
        rb1.rotate(rb1.root.leftChild, rb1.root);
        String currentTree = rb1.root.toString();
        String correctString = "[1, 0, 3, 2, 5, 4, 6]";
        assertEquals(correctString, currentTree);
	...
	public void week05ActivityTestPart3() {
        ...
        rb1.insert(18);  
        rb1.insert(9);
        rb1.rotate(rb1.root.leftChild.leftChild, rb1.root.leftChild);
        String currentTree = rb1.root.toString();
        String correctString = "[63, 18, 91, 9, 21]";
        assertEquals(correctString, currentTree);
